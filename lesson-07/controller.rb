class Controller
  ...
  def create_train
    ...
    if train_type == 1
      ...
      puts "Train created. Number: #{train_number}, type: #{train_type}."
    elsif train_type == 2
  ...
  def edit_route
    ...
    if action == 1
      ...
      puts "Station #{station_to_add.title} added to the route."
    elsif action == 2
      ...
      puts "Station #{station_to_remove} removed from the route."
    else
  ...
  def run
    ...
    loop do
      ...
      when 13 then show_vagons
      when 14 then fill_vagon
      else wrong_command
      end
    end
  end
